...
import { Container, FormContainer, BackgroundContainer, ErrorMessage, Logo, Form, HalfWidth, FloatingLabel, BottomLinks, LinkTitle, Link, ShowPass } from './auth.styled';
